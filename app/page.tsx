...
export default function Home() {
  ...
  const continents = [
    {
      key: 'europe',
      name: t('continent.europe'),
      description: t('continent.europe.desc'),
      image: "/europe.jpg",
    ...
    {
      key: 'africa',
      name: t('continent.africa'),
      description: t('continent.africa.desc'),
      image: "/africa.jpg",
    ...
    {
      key: 'asia',
      name: t('continent.asia'),
      description: t('continent.asia.desc'),
      image: "/asia.jpg",
      size: "md:col-span-1 lg:col-span-1",
      height: "h-80 md:h-80",
    },
    {
      key: 'americas',
      name: t('continent.americas'),
      description: t('continent.americas.desc'),
      image: "/americas.jpg",
      size: "md:col-span-1 lg:col-span-1",
      height: "h-80 md:h-80",
    },
    {
      key: 'oceania',
      name: t('continent.oceania'),
      description: t('continent.oceania.desc'),
      image: "/oceania.jpg",
      size: "md:col-span-1 lg:col-span-1",
      height: "h-80 md:h-80",
    },
      ...
      <div className="container mx-auto px-4 py-12 max-w-7xl">
                ...
                <div className="flex gap-3">
                  ...
                  <button className="relative px-5 py-2 text-sm font-medium text-white rounded-lg overflow-hidden group/quiz">
                    <Link href={`/quiz/${continent.key}`}>
                      ...
                      <span className="relative">{t('home.quiz')}</span>
                    </Link>
                  </button>
                </div>
              </div>
        ...
        <div className="flex justify-center items-center">
          <div className="flex flex-col items-center gap-2">
            <div className="text-slate-500 text-xs uppercase tracking-wider">{t('home.total')}</div>
